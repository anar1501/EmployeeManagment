...
@WebServlet(name = "ErrorInfoController", urlPatterns = {"/error-info"})
public class ErrorInfoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("errorinfopage.jsp").forward(request, response);
    }
