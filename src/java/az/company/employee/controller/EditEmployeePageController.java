...
@WebServlet(name = "EditEmployeePageController", urlPatterns = {"/private/edit-employee-page"})
public class EditEmployeePageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/editemployeepage.jsp").forward(request, response);
    }
