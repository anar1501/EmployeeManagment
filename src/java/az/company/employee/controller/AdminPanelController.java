...
@WebServlet(name = "AdminPanelController", urlPatterns = {"/admin/admin-panel"})
public class AdminPanelController extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        request.setAttribute("adminname", "Admin Panel");
        request.setAttribute("admin_url", "#");
        ...
        request.setAttribute("selected_admin", "active");

        request.getRequestDispatcher("/adminpanelpage.jsp").forward(request, response);
    }
