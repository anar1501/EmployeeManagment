...
@WebServlet(name = "EditEmployeeSaveController", urlPatterns = {"/private/edit-employee-save"})
public class EditEmployeeSaveController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("submit") != null) {
            ...
            employeeDaoService.updateById(employee);
